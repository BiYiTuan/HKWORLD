...
public class ProgramAdapter extends BaseAdapter<VodProgram> {

	private DisplayImageOptions mOptions;
	
	public ProgramAdapter(Context context, List<VodProgram> list) {
		super(context, list);
	...
	public View getView(int position, View convertView, ViewGroup viewGroup) {
		...
		if (null == convertView) {
			...
			convertView = mInflater.inflate(R.layout.program_item, null);
	...
	private void initHolder(ViewHolder holder, View view) {
		holder.image = (ImageView) view.findViewById(R.id.program_item_image);
		holder.name = (TextView) view.findViewById(R.id.program_item_name);
		holder.status=(ImageView) view.findViewById(R.id.program_img_status);
	}
