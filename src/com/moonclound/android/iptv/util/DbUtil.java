...
public class DbUtil extends SQLiteOpenHelper{
	...
	public void onCreate(SQLiteDatabase db) {
		// TODO Auto-generated method stub
		   ...
		   db.execSQL("CREATE TABLE IF NOT EXISTS collcetion (id integer primary key autoincrement, sid INTEGER UNIQUE,cid INTEGER,json varchar(255))");
    	...
    	try {
			db=getReadableDatabase();
			 ...
			 while(cursor.moveToNext()){  
		            ...
		            voditem=g.fromJson(json, new TypeToken<com.moon.android.model.VodProgram>(){}.getType());
